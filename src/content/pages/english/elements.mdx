...
const homepage = await getEntryCTM("homepage", "-index");
---
...
>
  Our partnership with marvindrone.com demonstrates the power of a well-executed customer
  ...
  rewarding customer experience. At marvindrone.com, we are committed to helping
